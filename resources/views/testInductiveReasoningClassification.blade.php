                    ...
                    <div class="col-md-12">
                        <h3 class="time-left">
                            @if($queList[$currentSoal]['EXAMPLE'] != 1)
                                ...
                                <input type="submit" name="next" class="btn btn-primary float-right" align="right" value="Selanjutnya" id="submitBtn" onclick="submitForm()" > 
                            @else
                            ...
                            <div class="col-lg-4">
                                <div class="item">
                                    <label for="answer_1" style="padding: 20px 0;">
                                        <input type="text" name="choice" id="answer_1"  class="txt-field-answer-number" maxlength="1" autocomplete="off" placeholder="..." pattern="[A-Za-z]" title="Isi dengan huruf" onblur="checkAnswer()" required>
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="item">
                                    <label for="answer_2" style="padding: 20px 0;">
                                        <input type="text" name="choice2" id="answer_2" class="txt-field-answer-number" maxlength="1" autocomplete="off" placeholder="..." pattern="[A-Za-z]" title="Isi dengan huruf" onblur="checkAnswer()" required>
                                    </label>
                                </div>
                            </div>
                        </div>
